...
TEST_CASE("Task 1") {
  ...
  auto bytes =
      hex::decode("49276d206b696c6c696e6720796f757220627261696e206c696b65206120"
...
TEST_CASE("Task 5") {
  ...
  const bytearray plaintext("Burning 'em, if you ain't quick and nimble\n"
                            "I go crazy when I hear a cymbal");
  const bytearray key("ICE");

  const bytearray expected =
      hex::decode("0b3637272a2b2e63622c2e69692a23693a2a3c6324202d62"
...
TEST_CASE("Task 8") {
  ...
  REQUIRE(find_ebc_encrypted_line(lines) == expected);
}
